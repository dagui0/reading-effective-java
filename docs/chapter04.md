...
* [**아이템 21**: 인터페이스는 구현하는 쪽을 생각해 설계하라](#아이템-21-인터페이스는-구현하는-쪽을-생각해-설계하라)
  * [**[추가]** 인터페이스 설계와 TDD](#추가-인터페이스-설계와-tdd)
...
* [**아이템 24**: 멤버 클래스는 되도록 `static`으로 만들라](#아이템-24-멤버-클래스는-되도록-static으로-만들라)
* [**아이템 25**: 톱레벨 클래스는 한 파일에 하나만 담으라](#아이템-25-톱레벨-클래스는-한-파일에-하나만-담으라)
* [**[추가]** `@NonNull`, `@Nonnull`, `@NotNull`, `@Nullable`, `@NotBlank`, `@NotEmpty` 등](#추가-nonnull-nonnull-notnull-nullable-notblank-notempty-등)
